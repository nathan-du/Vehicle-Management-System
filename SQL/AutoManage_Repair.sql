...
CREATE TABLE `Repair` (
  `repairNum` varchar(20) NOT NULL,
  `autoNum` varchar(10) NOT NULL,
  `repairDate` date NOT NULL,
  `name` varchar(20) NOT NULL,
  `repairPart` varchar(20) NOT NULL,
  `repairFee` double NOT NULL,
...
INSERT INTO `Repair` VALUES ('160414001','29834','2016-04-14','Sherrie','Lamp',100);
