...
CREATE TABLE `Driver` (
  `idDriver` varchar(18) NOT NULL,
  `name` varchar(10) NOT NULL,
  `gender` varchar(6) NOT NULL,
  `birthdate` date NOT NULL,
  `licensedate` date NOT NULL,
  `filenum` varchar(12) NOT NULL,
...
INSERT INTO `Driver` VALUES ('370321199408093937','Nathan','Male','1994-08-09','2013-08-06','370301134012','C','15310487778','673650096');
